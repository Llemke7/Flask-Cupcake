...
def test_update_cupcake(self):
    ...
    with app.test_client() as client:
        ...
        self.assertEqual(data['cupcake']['rating'], 4.8)
        self.assertEqual(data['cupcake']['image'], "http://test.com/updated-cupcake.jpg")
        ...
        self.assertEqual(updated_cupcake.rating, 4.8)
        self.assertEqual(updated_cupcake.image, "http://test.com/updated-cupcake.jpg")
